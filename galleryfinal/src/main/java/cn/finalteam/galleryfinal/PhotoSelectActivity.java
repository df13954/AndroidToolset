...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private void setTheme() {
        ...
        if (GalleryFinal.getGalleryTheme().getIconBack() == R.drawable.ic_nav_back_2x) {
    ...
    private void photoItemClick(View view, int position) {
        ...
        if (holder != null) {
            if (checked) {
                holder.mIvCheck.setBackgroundResource(R.drawable.ic_choosepic_02_2x);
...
//                holder.mIvCheck.setBackgroundColor(GalleryFinal.getGalleryTheme().getCheckNornalColor());
                holder.mIvCheck.setBackgroundResource(R.drawable.ic_choosepic_01_2x);
            }
        } else {
            mPhotoListAdapter.notifyDataSetChanged();
        }
